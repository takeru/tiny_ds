...
This is a Rails 2.3.5 integration plugin for TinyDS,
that provides ActiveRecord method calls for generated scaffold.
...
Example:
 ...
 ./script/generate td_model author name:stringage:integer —skip-timestamps
